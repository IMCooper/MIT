  ...
  const Quadrature<dim> &quadrature) const
{
  ...
  switch (dim)
  {
    ...
    case 3:
    {
      ...
      const int sigma_comp_signs[vertices_per_cell][3]
                                         ...
                                         InternalData                                         &fe_data) const
{
  ...
  if (degree>0)
  {
    ...
    if (flags & update_values | update_gradients)
    {
      ...
      const unsigned int vertex_opposite_on_face[vertices_per_face]
      = {3, 2, 1, 0};
      
      const unsigned int vertices_adjacent_on_face[vertices_per_face][2]
      = {{1,2}, {0,3}, {0,3}, {1,2}};
